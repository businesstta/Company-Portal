...
const corporateRequestUpload=(req:Request,res:Response,next:NextFunction)=>(String(req.query.type)==='advance_clearance'?clearanceAttachmentUpload:attachmentUpload).array('attachments',String(req.query.type)==='advance_clearance'?20:5)(req,res,next)
