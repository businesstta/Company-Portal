CREATE TABLE IF NOT EXISTS hr_course_masters (
...
CREATE UNIQUE INDEX IF NOT EXISTS hr_course_masters_code ON hr_course_masters(company_id,item_type,lower(code));
